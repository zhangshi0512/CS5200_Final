...
-- SELECT * FROM ChacterEquippedGear;
-- SELECT * FROM GearType;
-- SELECT * FROM WeaponType;
-- SELECT * FROM GearSlot;
-- SELECT * FROM Item;
-- SELECT * FROM Job;
-- SELECT * FROM CharacterJob;
-- SELECT * FROM Consumable;
-- SELECT * FROM WeaponTypeJob;
-- SELECT * FROM GearTypeJob;
-- SELECT * FROM GearSlot;
-- SELECT * FROM `Character`;

SELECT CharacterID, `Name`
FROM CharacterJob 
	JOIN Job ON CharacterJob.JobId = Job.JobId 
WHERE CharacterJob.CharacterID IN (
	SELECT CharacterID
	FROM CharacterJob
	GROUP BY CharacterID
	HAVING count(*) >= 2
)
ORDER BY CharacterID, `Name`;

SELECT `Name` AS JobName
FROM Job
JOIN GearTypeJob ON Job.JobID = GearTypeJob.JobID
GROUP BY Job.JobID
HAVING COUNT(DISTINCT GearTypeJob.GearType) >= 2;
